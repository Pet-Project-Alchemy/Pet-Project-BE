...
const { addUser, removeUser, getUser } = require('./utils/connect'); 
...
io.on('connection', (socket) => {
  let roomName = null;
  socket.on('join', ({ senderId, receiverId }, done) => {
  ...
  socket.on('sendMessage', (text, done) => {
    Message
      .create({
        senderId: socket.senderId, 
        receiverId: socket.receiverId, 
  ...
  socket.on('sendLocation', (coords, done) => {
    Message
      .create({
        senderId: socket.senderId, 
        receiverId: socket.receiverId, 
